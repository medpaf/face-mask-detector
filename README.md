...
The easiest way to use this program is to run the gui.py file (only supported on UNIX systems). If you are using the Windows operating systems run the code (detect_mask_image.py or detect_mask_video.py) directly.
